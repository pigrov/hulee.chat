/**
 * Cross-table Conversation/ConversationHead/Timeline invariants cannot be
 * represented by Drizzle table declarations. The append-only migration that
 * owns this exact block is deliberately checked by `pnpm db:check`.
 */
export const INBOX_V2_CONVERSATION_TIMELINE_HEAD_INTEGRITY_SQL = String.raw`
