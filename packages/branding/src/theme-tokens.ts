...
export const brandThemePresets: readonly BrandThemePreset[] = [
  {
    ...
    tokens: {
      ...
      "color.surface.raised": "#fdfdff",
      "color.surface.muted": "#f0f1ff",
      "color.border": "#dfe5fb",
      "color.border.strong": "#bfc8f2",
      "color.text.default": "#101a3d",
      "color.text.muted": "#65739f",
  ...
  },
  {
    ...
    tokens: {
      "color.page": "#090d1f",
      "color.surface.default": "#11162b",
      "color.surface.raised": "#171d35",
      "color.surface.muted": "#202747",
      "color.border": "#30395f",
      "color.border.strong": "#52609a",
      "color.text.default": "#f7f8ff",
      "color.text.muted": "#bac4ea",
      "color.brand.primary": "#a5b4fc",
      "color.brand.foreground": "#11162b",
      "color.accent": "#818cf8",
      "color.danger": "#fb7185",
